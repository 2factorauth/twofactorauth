...
If a site requires the user to do something out of the ordinary to set up 2FA or if 2FA is only available in specific countries, you can note this on the
website.
